...
import {deleteSingleProject} from "@/features/projects/projectSlice";
function DeleteModal({onClose, userid}) {
  ...
  const handleDelete = () => {
    dispatch(deleteSingleProject(userid)).then(() => {
      closeDelteModal();
        ...
        <div className='relative p-4 w-full max-w-md h-full md:h-auto'>
          <div className='relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5'>
            ...
            <p className='mb-4 text-gray-500 dark:text-gray-300'>
              Are you sure you want to delete this Project?  Once Deleted it Cannot be Retained 
            </p>
